...
# from nets_ghost import resnet_v2_50, resnet_v2_101, resnet_v2_152
...
tf.flags.DEFINE_string('output_dir',
    '/headless/dyx/GhostNet++/ImageNet_5000/3Resmodels/original/TI-MI-FGSM', 'Output directory with images.')
...
def graph(x, y, i, x_max, x_min, grad):
    ...
    logits = (logits_resnet_50+logits_resnet_101+logits_resnet_152) / 3
    #
    # logits = logits_v4
