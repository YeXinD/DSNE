...
#from nets_ghost import inception_v3
# from nets_original import inception_v3
...
tf.flags.DEFINE_string('output_dir',
    '/headless/dyx/GhostNet++/ImageNet_5000/Inc-v3/ghostnet/MI-FGSM(noAUX)', 'Output directory with images.')
