...
#from nets_ghost import resnet_v2_50
...
tf.flags.DEFINE_string('input_dir', '/headless/dyx/ghost-network-master/data/val_data5000', 'Input directory with images.')

tf.flags.DEFINE_string('output_dir',
    '/headless/dyx/GhostNet++/ImageNet_5000/Res50/ghostnet/TI-MI-FGSM(noAux)', 'Output directory with images.')
...
tf.flags.DEFINE_float('prob', 0.0, 'probability of using diverse inputs.')
...
def graph(x, y, i, x_max, x_min, grad):
    ...
    with slim.arg_scope(resnet_v2_50.resnet_arg_scope()):
        logits_resnet50, end_points_resnet50 = resnet_v2_50.resnet_v2_50(
            input_diversity(x), num_classes=num_classes, is_training=False)
    #
    # with slim.arg_scope(resnet_v2_101.resnet_arg_scope()):
    #     logits_resnet101, end_points_resnet101 = resnet_v2_101.resnet_v2_101(
    #         x, num_classes=num_classes, is_training=False)

    # with slim.arg_scope(resnet_v2_152.resnet_arg_scope()):
    #     logits_resnet152, end_points_resnet152 = resnet_v2_152.resnet_v2_152(
    #         input_diversity(x), num_classes=num_classes, is_training=False)


    # logits = (logits_v3 + logits_v4 + logits_res_v2 + logits_resnet) / 4

    logits = logits_resnet50
